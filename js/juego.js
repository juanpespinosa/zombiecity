...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 800, 290, 30, 30, 1),
    ...
    new Obstaculo('imagenes/valla_vertical.png', 580, 80, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 600, 90, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 430, 74, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 480, 284, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 850, 290, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 180, 270, 15, 30, 2),
    new Obstaculo('imagenes/auto_verde_abajo.png', 770, 200, 15, 30, 2),
    new Obstaculo('imagenes/auto_verde_derecha.png', 475, 400, 30, 15, 2),
    new Obstaculo('imagenes/auto_verde_derecha.png', 475, 420, 30, 15, 2),
  ],
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 0, 400, 10, 10, 3, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie2.png', 10, 420, 10, 10, 3, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie3.png', 15, 380, 10, 10, 3, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie4.png', 20, 395, 10, 10, 3, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie2.png', 25, 415, 10, 10, 3, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie3.png', 30, 405, 10, 10, 3, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie4.png', 35, 425, 10, 10, 3, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
    }),
    new ZombieCaminante('imagenes/zombie4.png', 20, 700, 10, 10, 3, {
      desdeX: 0,
      hastaX: 961,
      desdeY: 0,
      hastaY: 577
...
Juego.dibujarFondo = function() {
  ...
  // Si se gano el juego hay que mostrar el mensaje de ganoJuego de fondo
    ...
    //LLEGADA
    Dibujante.dibujarRectangulo('yellow', 758, 505, 130, 26);
  }
};
